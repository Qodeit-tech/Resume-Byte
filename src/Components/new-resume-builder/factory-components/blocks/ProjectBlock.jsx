    ...
    return (
        <>
            <div className='flex flex-col md:flex-row items-center justify-between'>
                <div className='w-[100%] md:w-[48%] h-[80px]'><InputControl field="Title" errmsg="invalid" isComp placeholder="Creator" set={setTitle} /></div>
                <div className='w-[100%] md:w-[48%] h-[80px]'><InputControl field="Link" errmsg="invalid" placeholder="Github.com (Optional)" set={setLink} /></div>
            </div>
